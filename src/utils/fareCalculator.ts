...
export const DEFAULT_PRICING = {
  baseFare: 0.0,           // ₹0 base fee
  baseIncludedKm: 0.0,      // 0 km included in base
  perKmRate: 0.0,           // ₹0 per km
  perMinuteRate: 0.0,       // ₹0 per minute
  minimumFare: 0.0,        // ₹0 absolute minimum ride charge
