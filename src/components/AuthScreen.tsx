  ...
  return (
    <div className="w-full max-w-md mx-auto py-8 px-4">
      ...
      <div className="text-center mb-6">
        <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-tr from-amber-500 to-amber-300 text-slate-950 font-black text-2xl shadow-xl shadow-amber-500/20 mb-3">
          M
        </div>
